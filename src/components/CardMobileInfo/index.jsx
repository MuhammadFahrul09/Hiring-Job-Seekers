    ...
    return (
        <div>
            <div
                ...
                {
                    isData.map((item, i) => (
                        <div className="w-full px-4 mt-2 bg-white rounded-lg">
                            <div className="flex items-center justify-between py-4 card-profil">
                                <div className="flex items-center ">
                                    ...
                                    <div>
                                        <p className="mb-3 text-sm font-semibold text-black">{item.name_company}</p>
